...
class NotificationUtil {
    companion object{
        ...
        private const val CHANNEL_NAME_TIMER = "Street App Timer"
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            val dataFormat = SimpleDateFormat.getTimeInstance(SimpleDateFormat.SHORT)


            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Timer is running!!")
                .setContentText("End: ${dataFormat.format(Date(wakeUpTime))}")
                .setContentIntent(getPendingIntentWithStack(context, MainActivity::class.java))
                .setOngoing(true)
        ...
        private fun getBasicNotificationBuilder(context: Context, channelIdTimer: String, playSound: Boolean): NotificationCompat.Builder {
